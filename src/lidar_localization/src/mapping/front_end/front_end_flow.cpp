...
namespace lidar_localization {
  FrontEndFlow::FrontEndFlow(std::shared_ptr<rclcpp::Node> node,
                            std::string cloud_topic,
                            std::string odom_topic,
                            std::string path_topic)
  {
    cloud_sub_ptr_ = std::make_shared<CloudSubscriber>(node, cloud_topic, 100000);
    laser_odom_pub_ptr_ = std::make_shared<OdometryPublisher>(node,
                                                    odom_topic,
                                                    path_topic,
                                                    "/world", 
                                                    "/lidar", 
