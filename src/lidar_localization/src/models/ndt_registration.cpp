...
namespace lidar_localization {
  NDTRegistration::NDTRegistration(const YAML::Node& node):ndt_ptr_(new pcl::NormalDistributionsTransform<CloudData::POINT, CloudData::POINT>())
  {
  ...
  NDTRegistration::NDTRegistration(float res,
                                  float step_size,
                                  float trans_eps,
                                  int max_iter):ndt_ptr_(new pcl::NormalDistributionsTransform<CloudData::POINT, CloudData::POINT>())
  {
    SetRegistrationParam(res, step_size, trans_eps, max_iter);
  }
                                              ...
                                              int max_iter)
  {
    ...
    std::cout<< "NDT matching parameters: " << std::endl
            << "res:" << res << ", "
            << "step_size" << step_size << ","
            << "trans_eps" << trans_eps << ","
            << "max_iter" << max_iter << ","
